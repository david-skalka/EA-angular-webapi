...
#line hidden
 ...
 var updateValues = ElementAutoFaker.GenerateFromElement(Model); Model.Attributes.Where(x => !x.Type.IsPrimitive).ToList().ForEach(x=> createValues[x.Name + "Id"]=1); createValues["Id"]=1; 
